...
namespace Firma.Data.Migrations
{
    ...
    [Migration("20250619064415_DodanieTabeliUlubionychFilmow")]
    partial class DodanieTabeliUlubionychFilmow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Firma.Data.Data.AppSettings.Ustawienie", b =>
                {
                    b.Property<int>("IdUstawienia")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdUstawienia"));
                    ...
                    b.HasKey("IdUstawienia");

                    b.ToTable("Ustawienie");

                    b.HasData(
                        new
                        {
                            IdUstawienia = 1,
                            Klucz = "WelcomeHeadline",
                            Wartosc = "Witaj w MoviePortal!"
                        },
                        new
                        {
                            IdUstawienia = 2,
                            Klucz = "WelcomeText",
                            Wartosc = "Twoja baza najlepszych filmów."
                        },
                        new
                        {
                            IdUstawienia = 3,
                            Klucz = "BannerText",
                            Wartosc = "Odkryj świat kina z nami. Przeglądaj, oceniaj i dodawaj recenzje swoich ulubionych filmów."
                        });
                });
            ...
            modelBuilder.Entity("Firma.Data.Data.CMS.Strona", b =>
                {
                    ...
                    b.Property<int?>("KategoriaStopki")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Firma.Data.Data.Ulubione.UlubionyFilm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdUzytkownika", "IdFilmu")
                        .IsUnique();

                    b.ToTable("UlubioneFilmy");
                });
            ...
            modelBuilder.Entity("Firma.Data.Data.Ulubione.UlubionyFilm", b =>
                {
                    b.HasOne("Firma.Data.Data.Movie.Film", "Film")
                        .WithMany()
                        .HasForeignKey("IdFilmu")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Firma.Data.Data.Customers.User", "Uzytkownik")
                        .WithMany()
