...
namespace Firma.Intranet.Controllers
{
    public class StronaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdStrony,Tytul,Tresc,Link,Pozycja,PokazWNavbar,KategoriaStopki")] Strona strona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdStrony,Tytul,Tresc,Link,Pozycja,PokazWNavbar,KategoriaStopki")] Strona strona)
        {
